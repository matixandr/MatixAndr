...
[![My Skills](https://skillicons.dev/icons?i=rust,c,cpp,ts,js,kotlin,python,mysql,flask,django,git,html,css,scss,powershell,php,cmake,react,vue,next,java,bash,mongodb,nodejs,sqlite,postgres,tauri,unity,kotlin)](https://skillicons.dev)
